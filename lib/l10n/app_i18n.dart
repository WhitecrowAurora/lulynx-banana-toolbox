...
class AppI18n {
  ...
  static const Map<String, String> _en = {
    ...
    '发现新版本 {version}': 'New version found: {version}',
    '已跳过版本 {version}': 'Skipped version: {version}',
    '当前已是最新版本 {version}': 'Already up to date: {version}',
    '检查更新失败: {error}': 'Update check failed: {error}',
    '当前版本：{version}': 'Current version: {version}',
    '最新版本：{version}': 'Latest version: {version}',
    '发布说明': 'Release Notes',
    '暂无发布说明': 'No release notes available',
    '复制下载地址': 'Copy Download Link',
    '复制发布页地址': 'Copy Release Page Link',
    '下载地址已复制': 'Download link copied',
    '下载并安装': 'Download and Install',
    '跳过该版本': 'Skip This Version',
    '未找到可下载的 APK 资源': 'No downloadable APK asset found',
    '使用已下载的更新包 {version}': 'Using cached update package {version}',
    '开始下载更新 {version}': 'Starting update download {version}',
    '正在下载更新 {percent}%': 'Downloading update {percent}%',
    '正在下载更新...': 'Downloading update...',
    '更新包已下载，正在启动安装': 'Update downloaded, opening installer',
    '已打开安装器': 'Installer opened',
    '请允许安装未知来源应用后重试': 'Allow unknown app installs and retry',
    '启动安装失败': 'Failed to open installer',
    '下载更新失败: {error}': 'Update download failed: {error}',
    '暂不': 'Not now',
